...
if (isset($_POST['login'])) {
    ...
    $result = mysqli_query($con, "SELECT * FROM users WHERE email = '" . $username. "' and password = '" . md5($password) . "'");
          ...
          <div class="card card-signin my-5">
            <div class="card-body">
              ...
              <form class="form-signin" action="process.php" method="post">
                ...
                <input class="btn btn-lg btn-primary btn-block log" type="submit" name="Login" style="background-color:#ACD9E3;">Log In</input>
                <hr class="my-4">
